                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="font-weight-bold @if($user->answer_sheets()->where('level_id', $level->id)->count() == 0) text-danger @elseif(!$user->answer_sheets()->where('level_id', $level->id)->first()->finished) text-warning @else text-info @endif">Status: @if($user->answer_sheets()->where('level_id', $level->id)->count() == 0) Blank @elseif(!$user->answer_sheets()->where('level_id', $level->id)->first()->finished) On Progress @else Submitted @endif</p>
